    ...
    return(
        <div className="overflow-x-hidden overflow-y-hidden">
            <main className="mb-40 flex flex-col gap-[62px] row-start-2 items-center sm:items-start">
                <Navbar />
                <h1 className="-mt-1 mr-5 text-2xl font-bold hover:scale-105 transition-transform text-neutral-400 lg:mt-6 lg:ml-175 lg:text-4xl">LENGTH</h1>
                        ...
                        <div className="mt-4 -ml-53 lg:-ml-52">
                            <div className="">
                                <input type="number" 
                                    ...
                                    className="bg-white text-neutral-500 text-base rounded-2xl pl-2 -px-60 p-1 scale-120 lg:scale-125 lg:-ml-2 focus:outline-white"
