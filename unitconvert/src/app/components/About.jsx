...
export default function About() {
    return(
        <div className="mt-30 mb-10 scale-70 lg:scale-100 lg:ml-100 lg:mr-100 text-xl font-bold flex flex-col lg:flex lg:flex-col lg:mt-40 ">
            <label className="-mt-60 lg:-mt-20 -ml-6 lg:ml-10  text-3xl lg:text-4xl text-neutral-400 mr-10 lg:mr-100 hover:scale-105 transition-transform">Unit Converter Project</label>
