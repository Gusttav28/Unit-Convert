...
export default function Tempeture() {
    ...
    const handleDegreeCelsius = () =>{
        degreeCelsius_value = 9 / 5  + 32 
        console.log(degreeCelsius_value)
    }
...
// --------------------------------Handle Convert----------------------------------------------------------------
    ...
    return(
        ...
        <main className="mb-40 flex flex-col gap-[62px] row-start-2 items-center sm:items-start">
            <Navbar />
            <h1 className="-mt-1 mr-5 text-2xl font-bold hover:scale-105 transition-transform text-neutral-400 lg:mt-6 lg:ml-167 lg:text-4xl">TEMPETURE</h1>
            <div className="ml-85 -mt-5 lg:ml-205 lg:mt-5 flex flex-col">
                <form>          
                    ...
                    <div className="-mt-8 ml-48 lg:-mt-8">
                        <div className="">
                            <select
                                className="bg-white text-neutral-500 text-sm py-2 px-2 pl-4 focus:outline-white scale-120 -ml-50 l:-ml-8 rounded-2xl"
                    ...
                    <div className="mt-4 mb-2 mr-2">
                        ...
                        <div className="flex items-center -mt-33 mr-30 -ml-4 scale-150 rounded-md lg:-px-10">
                            <input type="number" 
                                name="length"
                                typeof="number"
                                value={result}
                                disabled
                                className="bg-white text-neutral-500 text-sm rounded-2xl pl-2 -px-60 p-1 scale-69 lg:scale-85 lg:ml-2 focus:outline-white"
                            />
                        </div>
